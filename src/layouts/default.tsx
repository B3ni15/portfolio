...
export default function DefaultLayout({
  ...
  return (
    <div className="relative bg-[#0F1015] min-h-screen">
      ...
      <main className="relative z-10 pt-16 sm:pt-24 pb-16 min-h-[calc(100vh-6rem)]">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          {children}
        </div>
      </main>

      <footer className="mt-8 mb-4 mx-auto max-w-7xl px-4 sm:px-6 py-4 text-center text-default-400 text-sm sm:text-base">
